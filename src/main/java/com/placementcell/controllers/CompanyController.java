...
public class CompanyController {
	...
	{
		boolean status=companyDetailsService.delete(id);
		if(status) {
			return new ResponseEntity<Message>(new Message("Company Deleted Successfully"),HttpStatus.OK);
		}else {
			return new ResponseEntity<Message>(new Message("Company Not Found"),HttpStatus.BAD_REQUEST);
		}
	}
